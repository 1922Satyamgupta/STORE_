...
<body>
  <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <div class="navbar-nav">
      <div class="nav-item text-nowrap">
        <a class="nav-link px-3" href="/src/php/logout.php">Sign out</a>
      </div>
    </div>
  </header>
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse" style="background-color:rgb(255,82,82);">
        <div class="position-sticky pt-3">
          <ul class="nav flex-column">
            ...
            <?php if ($_SESSION["data"]["type"] == "admin") { ?>
              ...
              <li class="nav-item">
                <a class="nav-link" href="/ui-kit-main/src/home.php">
                  <span data-feather="users"></span>
                  Shop
                </a>
              </li>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="background-color: rgb(255,186,186);">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 class="h2"><strong>Dashboard</strong></h1>
          <?php if ($_SESSION["data"]["type"] == "admin") { ?>
            <div class="btn-toolbar mb-2 mb-md-0">
              <div class="btn-group me-2">
                <button type="button" class="btn btn-sm  btn-outline-dark" style="background-color:lightgrey;">Share</button>
                <button type="button" class="btn btn-sm btn-outline-dark"style="background-color:lightgrey;">Export</button>
              </div>
              <button type="button" class="btn btn-sm btn-outline-dark dropdown-toggle" style="background-color:lightgrey;">
